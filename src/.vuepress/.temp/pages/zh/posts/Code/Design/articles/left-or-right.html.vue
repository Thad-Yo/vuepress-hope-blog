<template><div><h2 id="左右横跳的泳道" tabindex="-1"><a class="header-anchor" href="#左右横跳的泳道" aria-hidden="true">#</a> 左右横跳的泳道</h2>
...
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-renren.jpg" alt="泳道" tabindex="0" loading="lazy"><figcaption>泳道</figcaption></figure>
<p>那么问题来了，究竟向哪个方向滑动呢?</p>
<p>或许您会觉得这是一个送分题，肯定是左滑啊；没错，您去查看 100 个 APP，这种水平横滑的泳道，99 个都是左滑的；但是人人视频就是那唯一的特例，它是左滑和右滑相互组合的。</p>
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-renren.gif" alt="人人交互" tabindex="0" loading="lazy"><figcaption>人人交互</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-sight.jpg" alt="视线路径" tabindex="0" loading="lazy"><figcaption>视线路径</figcaption></figure>
<p>人人视频的这种方案，让我想起夸克浏览器——用户在夸克浏览器里观看视频，如果点击屏幕的位置靠左，那么菜单就会出现在左边；如果点击的位置靠右，菜单就会出现在右边；这样的处理方式，可以缩短用户手指的移动距离。</p>
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-quark.gif" alt="夸克菜单" tabindex="0" loading="lazy"><figcaption>夸克菜单</figcaption></figure>
<p>一个是缩短视线移动距离，一个是缩短手指移动距离。</p>
<h2 id="左还是右" tabindex="-1"><a class="header-anchor" href="#左还是右" aria-hidden="true">#</a> 左还是右</h2>
...
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-L.jpg" alt="视线移动" tabindex="0" loading="lazy"><figcaption>视线移动</figcaption></figure>
<p>iOS 11 与 iOS 10 相比，我们可以发现页面标题、搜索框文案和内容都是改成放在左边。</p>
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-app-store.jpg" alt="iOS页面对比" tabindex="0" loading="lazy"><figcaption>iOS页面对比</figcaption></figure>
<p>整体的视觉动线由中间改成了左边，用户在快速浏览过程中视线不需要发生偏移。</p>
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-app-store2.jpg" alt="iOS 页面对比" tabindex="0" loading="lazy"><figcaption>iOS 页面对比</figcaption></figure>
<p>右代表着更好的易用性。因为在移动端，用户更习惯单手握持手机进行操作；而我们大部分人都是右撇子。</p>
<p>谷歌的 MD 设计中的浮动按钮，是位于界面右侧；微信的浮窗也是位于界面右侧，就是为了方便用户操作。</p>
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-float.jpg" alt="浮动按钮" tabindex="0" loading="lazy"><figcaption>浮动按钮</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-direction.jpg" alt="文字方向" tabindex="0" loading="lazy"><figcaption>文字方向</figcaption></figure>
<h2 id="流量分发" tabindex="-1"><a class="header-anchor" href="#流量分发" aria-hidden="true">#</a> 流量分发</h2>
<p>当然也会有一些设计方案在“左/右”的选择上没这么纠结，例如在微博、抖音这类社交产品中，其主页的“推荐”栏目永远在“关注”栏目的左边。</p>
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-flow.jpg" alt="流量分发" tabindex="0" loading="lazy"><figcaption>流量分发</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-flow2.jpg" alt="流量分发" tabindex="0" loading="lazy"><figcaption>流量分发</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-flow3.jpg" alt="流量分发" tabindex="0" loading="lazy"><figcaption>流量分发</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/articles/assets/left-or-right-flow4.jpg" alt="流量分发" tabindex="0" loading="lazy"><figcaption>流量分发</figcaption></figure>
