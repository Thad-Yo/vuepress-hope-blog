<template><div><p>在 UI 设计中，图标不是孤立存在的。我们学习图标的设计，不是为了画一组套图，然后上传到设计平台中分享或求赞，而是要在真实的项目中发挥作用。如果不了解图标应用到项目中的知识点，那么真实的图标设计水平就会在项目设计过程中被损耗。</p>
<p>所以，本章讲述工具图标在项目中应用的方法。</p>
<!-- more -->
<h2 id="一套应用中的图标规格" tabindex="-1"><a class="header-anchor" href="#一套应用中的图标规格" aria-hidden="true">#</a> 一套应用中的图标规格</h2>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/place-same.jpg" alt="替换淘宝图标" tabindex="0" loading="lazy"><figcaption>替换淘宝图标</figcaption></figure>
<p>可以看见，右侧替换后的案例，效果非常的不理想，缺乏对比和趣味性。交互规则中说: 如无必要，勿增实体，但对于图标的使用来说，这就是必要。</p>
<hr>
<p>应用内的图标规格不同，可以用两个属性来划分，大小和风格。</p>
<h3 id="图标的尺寸" tabindex="-1"><a class="header-anchor" href="#图标的尺寸" aria-hidden="true">#</a> 图标的尺寸</h3>
<p>大小就是图标的尺寸规格，有些界面的元素权重低，图标的尺寸就小，有些权重高的则反之。比如在 Apple Music 的播放界面，播放快进等按钮，作为页面最重要的按钮，尺寸非常大，其它可以点击的图标次之，而表示音量的两个按钮则最小。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/icon-size.jpg" alt="图标尺寸" tabindex="0" loading="lazy"><figcaption>图标尺寸</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/icon-template.jpg" alt="图标模板" tabindex="0" loading="lazy"><figcaption>图标模板</figcaption></figure>
...
<h3 id="图标的风格" tabindex="-1"><a class="header-anchor" href="#图标的风格" aria-hidden="true">#</a> 图标的风格</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/58icon.jpg" alt="58 同城图标" tabindex="0" loading="lazy"><figcaption>58 同城图标</figcaption></figure>
<p>通常，一种风格会应用在一种「类别」的图标中。上方案例属于比较理想的状态，一种类别的图标对应一种尺寸，但是在一些更复杂的环境中，往往同一种尺寸下还会包括不同类别的图标。</p>
<h2 id="图标的不同状态" tabindex="-1"><a class="header-anchor" href="#图标的不同状态" aria-hidden="true">#</a> 图标的不同状态</h2>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/icon-change.jpg" alt="改变图标状态" tabindex="0" loading="lazy"><figcaption>改变图标状态</figcaption></figure>
<p>还有，一些包含在控件内的图标，也会跟随控件状态的变更发生变更。例如在账号输入框中，如果选中了输入框，那么图标的色彩也得到改变。如果输入框目前处于不可输入状态，那么图标也会对应置灰。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/icon-change2.jpg" alt="改变图标状态" tabindex="0" loading="lazy"><figcaption>改变图标状态</figcaption></figure>
<p>合格的 UI 设计师会充分考虑到图标所变换的各种状态，并在提交给开发的过程中会进行详细的说明、归类。以及，充分运用 Sketch 等软件中的组件功能，提升项目的效率和最后的产出成果。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/sketch.jpg" alt="提升效率" tabindex="0" loading="lazy"><figcaption>提升效率</figcaption></figure>
<h2 id="图标的标注和切图" tabindex="-1"><a class="header-anchor" href="#图标的标注和切图" aria-hidden="true">#</a> 图标的标注和切图</h2>
...
<h3 id="图标的边界" tabindex="-1"><a class="header-anchor" href="#图标的边界" aria-hidden="true">#</a> 图标的边界</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/border.jpg" alt="图标的边界" tabindex="0" loading="lazy"><figcaption>图标的边界</figcaption></figure>
<p>所以，要让标注有效，就一定不要偷懒只把图标置入画布中，而没有透明矩形背景。</p>
<h3 id="图标的画布" tabindex="-1"><a class="header-anchor" href="#图标的画布" aria-hidden="true">#</a> 图标的画布</h3>
...
<h3 id="图标的命名" tabindex="-1"><a class="header-anchor" href="#图标的命名" aria-hidden="true">#</a> 图标的命名</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/name-example.jpg" alt="命名示例" tabindex="0" loading="lazy"><figcaption>命名示例</figcaption></figure>
<h3 id="图标的格式" tabindex="-1"><a class="header-anchor" href="#图标的格式" aria-hidden="true">#</a> 图标的格式</h3>
<p>上一章启动图标的导出格式，会根据不同设备、场景导出不同的尺寸，并且使用 PNG 的格式。不要担心，工具图标虽然也面临设备不同的问题，但不需要导出这么多的规格。下面讲讲两种图标的导出类型。</p>
<h4 id="位图格式" tabindex="-1"><a class="header-anchor" href="#位图格式" aria-hidden="true">#</a> 位图格式</h4>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/png-export.jpg" alt="位图导出" tabindex="0" loading="lazy"><figcaption>位图导出</figcaption></figure>
...
<h4 id="矢量格式" tabindex="-1"><a class="header-anchor" href="#矢量格式" aria-hidden="true">#</a> 矢量格式</h4>
