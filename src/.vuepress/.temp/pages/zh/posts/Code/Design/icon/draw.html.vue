<template><div><h2 id="情绪板" tabindex="-1"><a class="header-anchor" href="#情绪板" aria-hidden="true">#</a> 情绪板</h2>
...
<h3 id="选取照片" tabindex="-1"><a class="header-anchor" href="#选取照片" aria-hidden="true">#</a> 选取照片</h3>
<p>观察生活，对想画的图标进行照片实物造型的提取。图标是对生活中事物的精简概括。利用现实照片作为设计参考可以让绘制出的图标更真实，辨识度更高，还可以做到差异化设计。</p>
<h3 id="造型勾勒" tabindex="-1"><a class="header-anchor" href="#造型勾勒" aria-hidden="true">#</a> 造型勾勒</h3>
<p>使用矢量软件的基本图形与钢笔工具描着照片进行轮廓的绘制。</p>
<h3 id="简化优化" tabindex="-1"><a class="header-anchor" href="#简化优化" aria-hidden="true">#</a> 简化优化</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/design-step.jpg" alt="图标制作流程" tabindex="0" loading="lazy"><figcaption>图标制作流程</figcaption></figure>
<h2 id="制定规范" tabindex="-1"><a class="header-anchor" href="#制定规范" aria-hidden="true">#</a> 制定规范</h2>
