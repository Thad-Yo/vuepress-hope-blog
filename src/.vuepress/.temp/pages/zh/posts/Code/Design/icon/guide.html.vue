<template><div><h2 id="图标的可用性" tabindex="-1"><a class="header-anchor" href="#图标的可用性" aria-hidden="true">#</a> 图标的可用性</h2>
<p>图标可用性，顾名思义就是图标绘制出来是否能被用户所看懂并快速识别，是否可以为业务赋能。以下是总结的四条图标绘制的评判标准。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/rule.jpg" alt="图标绘制的评判标准" tabindex="0" loading="lazy"><figcaption>图标绘制的评判标准</figcaption></figure>
<h3 id="凸显性" tabindex="-1"><a class="header-anchor" href="#凸显性" aria-hidden="true">#</a> 凸显性</h3>
<p>用户是否能在某页面上迅速找到该图标，凸显性的目的是可以快速查找，帮助用户做选择。图标在识别的速度上远远大于文字，所以在一些页面中的重要功能使用图标的目的是为了吸引用户的注意力，让重要功能得到凸显，提高重要功能的点击率。</p>
<h3 id="可识别性" tabindex="-1"><a class="header-anchor" href="#可识别性" aria-hidden="true">#</a> 可识别性</h3>
...
<h3 id="美观度" tabindex="-1"><a class="header-anchor" href="#美观度" aria-hidden="true">#</a> 美观度</h3>
...
<h3 id="业务属性" tabindex="-1"><a class="header-anchor" href="#业务属性" aria-hidden="true">#</a> 业务属性</h3>
<p>图标是否符合业务属性，是否可以唤起用户的使用情绪，提高点击率，起到为业务赋能的作用。在界面中图标最终目的不只是让用户觉得它美观，而是要为产品赋能，什么是为产品赋能呢? 通俗来说就是使图标能够提升点击率从而给公司创造收益。</p>
<h3 id="图标如何为产品赋能" tabindex="-1"><a class="header-anchor" href="#图标如何为产品赋能" aria-hidden="true">#</a> 图标如何为产品赋能</h3>
<ul>
<li>
...
<h2 id="图标类型选取" tabindex="-1"><a class="header-anchor" href="#图标类型选取" aria-hidden="true">#</a> 图标类型选取</h2>
<h3 id="线性图标" tabindex="-1"><a class="header-anchor" href="#线性图标" aria-hidden="true">#</a> 线性图标</h3>
<p>线性图标，顾名思义，即图标是由直线、曲线、点在内等元素组合而成的图标样式。</p>
<p><strong>优点</strong>:</p>
<p>线性图标辨识度高，清晰唯美，简约易看，不会对页面造成太多的视觉干扰。</p>
<p><strong>缺点</strong>:</p>
<p>线性图标的创作空间较少，太复杂的线性图标看起来会让人感觉到累。</p>
<h3 id="面性图标" tabindex="-1"><a class="header-anchor" href="#面性图标" aria-hidden="true">#</a> 面性图标</h3>
...
<h3 id="混合型图标" tabindex="-1"><a class="header-anchor" href="#混合型图标" aria-hidden="true">#</a> 混合型图标</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/icon-type.jpg" alt="不同图标类型" tabindex="0" loading="lazy"><figcaption>不同图标类型</figcaption></figure>
<h2 id="图标的色彩" tabindex="-1"><a class="header-anchor" href="#图标的色彩" aria-hidden="true">#</a> 图标的色彩</h2>
<h3 id="色彩情绪" tabindex="-1"><a class="header-anchor" href="#色彩情绪" aria-hidden="true">#</a> 色彩情绪</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/color-emotion.jpg" alt="色彩情绪表" tabindex="0" loading="lazy"><figcaption>色彩情绪表</figcaption></figure>
</div>
<h3 id="配色方法" tabindex="-1"><a class="header-anchor" href="#配色方法" aria-hidden="true">#</a> 配色方法</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/color-plan.jpg" alt="色调" tabindex="0" loading="lazy"><figcaption>色调</figcaption></figure>
<h3 id="配色方案" tabindex="-1"><a class="header-anchor" href="#配色方案" aria-hidden="true">#</a> 配色方案</h3>
<h4 id="常见的色彩搭配" tabindex="-1"><a class="header-anchor" href="#常见的色彩搭配" aria-hidden="true">#</a> 常见的色彩搭配</h4>
<ul>
<li>中性色(黑白) + 主色</li>
<li>主色 + 点缀色</li>
<li>主色 + 透明度</li>
...
<h4 id="点缀色配色" tabindex="-1"><a class="header-anchor" href="#点缀色配色" aria-hidden="true">#</a> 点缀色配色</h4>
<ul>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/color-rule.jpg" alt="色调" tabindex="0" loading="lazy"><figcaption>色调</figcaption></figure>
<h2 id="图标绘制技巧" tabindex="-1"><a class="header-anchor" href="#图标绘制技巧" aria-hidden="true">#</a> 图标绘制技巧</h2>
<h3 id="像素对齐" tabindex="-1"><a class="header-anchor" href="#像素对齐" aria-hidden="true">#</a> 像素对齐</h3>
<p>在绘制图标的时候，应该将图标的每个像素尽量对齐于像素点，这样导出图标时像素的边缘不会出现锯齿，不会出现过于模糊的情况。通常在绘制时去除绘制软件中 x 与 y 轴，宽(w)与高(h)的小数点，这样就可以避免无法对齐像素的情况。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/align.jpg" alt="图标对齐" tabindex="0" loading="lazy"><figcaption>图标对齐</figcaption></figure>
<h3 id="图标参考线" tabindex="-1"><a class="header-anchor" href="#图标参考线" aria-hidden="true">#</a> 图标参考线</h3>
<p>在绘制两个或者以上的图标时，为了避免多个图标出现大小不一的情况，应该使用由谷歌材料设计语言提供的图标参考线进行绘制，使用图标盒子可以让一整套图标在视觉效果上更加统一和谐，不会出现一大一小一长一短的情况。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/reference-line.jpg" alt="图标参考线" tabindex="0" loading="lazy"><figcaption>图标参考线</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/layout.jpg" alt="图标布局" tabindex="0" loading="lazy"><figcaption>图标布局</figcaption></figure>
<h3 id="可访问性" tabindex="-1"><a class="header-anchor" href="#可访问性" aria-hidden="true">#</a> 可访问性</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/access.jpg" alt="可访问性" tabindex="0" loading="lazy"><figcaption>可访问性</figcaption></figure>
<h3 id="统一性" tabindex="-1"><a class="header-anchor" href="#统一性" aria-hidden="true">#</a> 统一性</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/union.jpg" alt="统一性" tabindex="0" loading="lazy"><figcaption>统一性</figcaption></figure>
<h3 id="图标呼吸感" tabindex="-1"><a class="header-anchor" href="#图标呼吸感" aria-hidden="true">#</a> 图标呼吸感</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/space.jpg" alt="呼吸感" tabindex="0" loading="lazy"><figcaption>呼吸感</figcaption></figure>
<h3 id="合理运用布尔运算" tabindex="-1"><a class="header-anchor" href="#合理运用布尔运算" aria-hidden="true">#</a> 合理运用布尔运算</h3>
<p>布尔运算在设计行业中被得到广泛的运用，比如工业设计，影视后期，logo 设计等，布尔运算具有一致性与规范性的优点。在设计面性图标的时候可以合理使用布尔运算进行绘制，这样绘制的图标具有吸引力和说服力。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/bool.jpg" alt="合理运用布尔运算" tabindex="0" loading="lazy"><figcaption>合理运用布尔运算</figcaption></figure>
<h3 id="页面层次感" tabindex="-1"><a class="header-anchor" href="#页面层次感" aria-hidden="true">#</a> 页面层次感</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/index.jpg" alt="层次感" tabindex="0" loading="lazy"><figcaption>层次感</figcaption></figure>
<h3 id="符合业务属性" tabindex="-1"><a class="header-anchor" href="#符合业务属性" aria-hidden="true">#</a> 符合业务属性</h3>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/location.jpg" alt="图标风格" tabindex="0" loading="lazy"><figcaption>图标风格</figcaption></figure>
<h2 id="最终测试" tabindex="-1"><a class="header-anchor" href="#最终测试" aria-hidden="true">#</a> 最终测试</h2>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/center.jpg" alt="图标重心" tabindex="0" loading="lazy"><figcaption>图标重心</figcaption></figure>
</div></template>
