<template><div><p>了解了图标的类型，就要开始了解做出这些图标应该使用哪些软件了。通常，UI 主要使用的设计软件包含 PS、AI、Sketch、XD 四款，理论上，它们都包含了图标绘制的功能，下面介绍这四款软件对于图标设计的优劣，以及需要掌握的部分。</p>
<!-- more -->
<figure><img src="@source/zh/posts/code/Design/icon/assets/software.jpg" alt="使用软件" tabindex="0" loading="lazy"><figcaption>使用软件</figcaption></figure>
<h2 id="sketch-xd" tabindex="-1"><a class="header-anchor" href="#sketch-xd" aria-hidden="true">#</a> Sketch / XD</h2>
...
<h2 id="photoshop" tabindex="-1"><a class="header-anchor" href="#photoshop" aria-hidden="true">#</a> Photoshop</h2>
...
<h2 id="illastrator" tabindex="-1"><a class="header-anchor" href="#illastrator" aria-hidden="true">#</a> Illastrator</h2>
