<template><div><p>想要在启动图标设计上入门，就要先从规范开始学习，然后了解不同的风格以及对应风格的设计过程。</p>
<h2 id="启动图标的设计规范" tabindex="-1"><a class="header-anchor" href="#启动图标的设计规范" aria-hidden="true">#</a> 启动图标的设计规范</h2>
<p>说到启动图标的规范，首先会想到的，就是 iOS 提供的图标栅格。通过这个栅格，会规范图形的尺寸，以及所处的位置。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/ios-grid.jpg" alt="iOS 提供的图标栅格" tabindex="0" loading="lazy"><figcaption>iOS 提供的图标栅格</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-size.jpg" alt="不同的图标大小" tabindex="0" loading="lazy"><figcaption>不同的图标大小</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-size2.jpg" alt="不同的图标大小" tabindex="0" loading="lazy"><figcaption>不同的图标大小</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-generate.jpg" alt="不同图标生成" tabindex="0" loading="lazy"><figcaption>不同图标生成</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-cut.jpg" alt="图表的剪切" tabindex="0" loading="lazy"><figcaption>图表的剪切</figcaption></figure>
<p>如果我们想要设计出正方形图形后预览真实的效果，就可以用我们准备的 PSD 模板，将正方形置入到模板中即可。</p>
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-template.jpg" alt="启动图标模板" tabindex="0" loading="lazy"><figcaption>启动图标模板</figcaption></figure>
<p>在设计已经确认以后，我们就要导出这些图标。因为启动图标有很多拟物的设计或会使用真实的摄影素材，所以应用商店提交的格式会选用位图格式而不是矢量格式，所以导出启动图标，只需要导出对应尺寸的 PNG 即可。</p>
<h2 id="启动图标的设计演示" tabindex="-1"><a class="header-anchor" href="#启动图标的设计演示" aria-hidden="true">#</a> 启动图标的设计演示</h2>
<h3 id="图标形式" tabindex="-1"><a class="header-anchor" href="#图标形式" aria-hidden="true">#</a> 图标形式</h3>
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-icon2.jpg" alt="图标形式" tabindex="0" loading="lazy"><figcaption>图标形式</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-combine.jpg" alt="APP 组合" tabindex="0" loading="lazy"><figcaption>APP 组合</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-text2.jpg" alt="文字形式" tabindex="0" loading="lazy"><figcaption>文字形式</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/font-design.jpg" alt="字体设计" tabindex="0" loading="lazy"><figcaption>字体设计</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-tool.jpg" alt="拟物形式" tabindex="0" loading="lazy"><figcaption>拟物形式</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/icon/assets/app-tool-design.jpg" alt="iOS 文件设计" tabindex="0" loading="lazy"><figcaption>iOS 文件设计</figcaption></figure>
