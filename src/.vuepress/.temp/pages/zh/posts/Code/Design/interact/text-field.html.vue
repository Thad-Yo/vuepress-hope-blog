<template><div><p>文本框的出现几乎可以追溯到可视化交互诞生的源头，是一个再经典不过的「鼻祖」控件了。我们每天都在和文本框打交道，不论您是产品设计者还是用户。</p>
<h2 id="文本框的拆解" tabindex="-1"><a class="header-anchor" href="#文本框的拆解" aria-hidden="true">#</a> 文本框的拆解</h2>
<p>文本框(Text Fields)根据 Material Design 指导规范，被拆解为七个部分。分别是:</p>
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field.jpg" alt="文本框的拆解" tabindex="0" loading="lazy"><figcaption>文本框的拆解</figcaption></figure>
<ul>
<li>容器(Container)</li>
...
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-original.jpg" alt="文本框基础样式" tabindex="0" loading="lazy"><figcaption>文本框基础样式</figcaption></figure>
<p>这就是一个文本框最基础的样式了， 一个标签文本+容器，已经基本可以确保向用户传递文本框最直观的信息。</p>
<p>但如今的文本框已经演变出了形形色色的样式和交互形式，究竟 MD 的文本框是如何演变到今天这番样子?</p>
<h2 id="基础的文本框布局方式" tabindex="-1"><a class="header-anchor" href="#基础的文本框布局方式" aria-hidden="true">#</a> 基础的文本框布局方式</h2>
...
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-align.jpg" alt="文本框对齐" tabindex="0" loading="lazy"><figcaption>文本框对齐</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-align2.jpg" alt="文本框对齐" tabindex="0" loading="lazy"><figcaption>文本框对齐</figcaption></figure>
...
<h2 id="文本框的改良" tabindex="-1"><a class="header-anchor" href="#文本框的改良" aria-hidden="true">#</a> 文本框的改良</h2>
<p>当文本框横向布局或是纵向布局都很难解决具体场景问题的时候，更新颖的文本框交互形式就出现了。</p>
<p>最初的演变形式是众多的应用开始采用前导图标来替代标签文本，使用图标可以有效地解决标签文本导致的排版错落问题。</p>
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-icon.jpg" alt="图标提示" tabindex="0" loading="lazy"><figcaption>图标提示</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-placeholder.jpg" alt="iOS 占位符提示" tabindex="0" loading="lazy"><figcaption>iOS 占位符提示</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-md.gif" alt="MD 标签" tabindex="0" loading="lazy"><figcaption>MD 标签</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-placeholder-search.jpg" alt="引流" tabindex="0" loading="lazy"><figcaption>引流</figcaption></figure>
<h2 id="合理的反馈" tabindex="-1"><a class="header-anchor" href="#合理的反馈" aria-hidden="true">#</a> 合理的反馈</h2>
<p>合理的反馈机制对于提升用户填写文本框效率也起着重要的作用，MD 规范中的帮助文本不仅仅是告诉设计者可以用于指导用户该如何正确填写文本框信息，也为反馈提示提供了展示空间。</p>
<p>MD 的反馈状态可以归纳为以下几种:</p>
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-feedback.jpg" alt="反馈" tabindex="0" loading="lazy"><figcaption>反馈</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/interact/assets/text-field-feedback2.jpg" alt="反馈" tabindex="0" loading="lazy"><figcaption>反馈</figcaption></figure>
