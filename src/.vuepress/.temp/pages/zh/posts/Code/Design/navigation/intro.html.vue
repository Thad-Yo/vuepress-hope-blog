<template><div><p>其实网页或者 App 中的导航(Navigation)这个概念远不止我们熟悉的导航栏，而是一个更加广的交互概念: 引导用户和产品进行有效的交互，实现用户的目标。本文将详细地介绍界面的导航设计。</p>
...
<h2 id="菜单-menu" tabindex="-1"><a class="header-anchor" href="#菜单-menu" aria-hidden="true">#</a> 菜单(Menu)</h2>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/color.jpg" alt="颜色的设计" tabindex="0" loading="lazy"><figcaption>颜色的设计</figcaption></figure>
<p>这个 UI 概念设计的例子很好的运用了颜色作为标记，这是一种很有效的导航技巧: 每个分类的背景色使用了和目录相同的的颜色，这样目录和内容有着非常强的相关性，用户能自然地将他们联系起来。</p>
<h2 id="行为召唤-cta" tabindex="-1"><a class="header-anchor" href="#行为召唤-cta" aria-hidden="true">#</a> 行为召唤(CTA)</h2>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/CTA-example.gif" alt="APP 案例" tabindex="0" loading="lazy"><figcaption>APP 案例</figcaption></figure>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/CTA-example.jpg" alt="网站着陆页" tabindex="0" loading="lazy"><figcaption>网站着陆页</figcaption></figure>
...
<h2 id="条-bar" tabindex="-1"><a class="header-anchor" href="#条-bar" aria-hidden="true">#</a> 条(Bar)</h2>
<p>条(Bar)指的是界面中一组用户可以点击的元素，用来快速与产品进行互动，或者还能让用户知道事件的进程。</p>
<h3 id="标签条-bar" tabindex="-1"><a class="header-anchor" href="#标签条-bar" aria-hidden="true">#</a> 标签条(Bar)</h3>
<p>最基本的条是标签条(Tab bars)，常出现在 APP 界面的底部，让用户能在 APP 的不同模块间快速切换。</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/tabbar.jpg" alt="Tabbar" tabindex="0" loading="lazy"><figcaption>Tabbar</figcaption></figure>
<h3 id="载入条-loading-bar" tabindex="-1"><a class="header-anchor" href="#载入条-loading-bar" aria-hidden="true">#</a> 载入条(Loading bar)</h3>
<p>载入条是用来告知某个动作的进展，用户可以通过时间、百分比或者其他信息了解整个过程。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>比如本博客在跳转新页面的时候导航栏下方就会出现载入条</p>
</div>
<h3 id="进度条-progress-bar" tabindex="-1"><a class="header-anchor" href="#进度条-progress-bar" aria-hidden="true">#</a> 进度条(Progress bar)</h3>
<p>给用户提供反馈，让他们了解事件的进度，比如说计划的事情完成了多少。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>最常见的就是音乐和视频 APP</p>
</div>
<h2 id="按钮-button" tabindex="-1"><a class="header-anchor" href="#按钮-button" aria-hidden="true">#</a> 按钮(Button)</h2>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/404.jpg" alt="404 页面" tabindex="0" loading="lazy"><figcaption>404 页面</figcaption></figure>
<hr>
<p>以下是在 APP 和网页设计中常用的几种具备附加功能的按钮。</p>
<h3 id="汉堡按钮" tabindex="-1"><a class="header-anchor" href="#汉堡按钮" aria-hidden="true">#</a> 汉堡按钮</h3>
...
<h3 id="加号按钮-plus-button" tabindex="-1"><a class="header-anchor" href="#加号按钮-plus-button" aria-hidden="true">#</a> 加号按钮(Plus button)</h3>
<p>一般通过这个按钮，用户可以实现添加某个内容的动作，比如添加新的联系人，状态，笔记，位置等所有用户在产品里能做的基本动作。有时候，点击这个按钮会出现新的窗口。有时候还会出现一些选项供用户进行选择添加什么内容，这取决于是什么产品。</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/plus-button.jpg" alt="加号按钮" tabindex="0" loading="lazy"><figcaption>加号按钮</figcaption></figure>
<p>上面这个例子就是用户在点击加号按钮后出现了可以选择添加的内容(图片，视频，文字)，在选择了之后才会弹出添加内容的窗口。尽管这个操作可能增加一些额外的交互动作，但因为给予了用户选择空间，所以还是对用户很友好的一种设计。</p>
<h3 id="分享按钮-share-button" tabindex="-1"><a class="header-anchor" href="#分享按钮-share-button" aria-hidden="true">#</a> 分享按钮(Share Button)</h3>
<p>分享按钮顾名思义就是能让用户把内容分享到他们的社交平台账号上。大多数情况下，这个按钮都是用社交平台的 Logo 作为视觉形象，这样非常易于识别和认知。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>比如 in 东师小程序大部分页面都会在右下角展示分享浮窗</p>
</div>
<h2 id="开关-switch" tabindex="-1"><a class="header-anchor" href="#开关-switch" aria-hidden="true">#</a> 开关(Switch)</h2>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/switch.gif" alt="开关案例" tabindex="0" loading="lazy"><figcaption>开关案例</figcaption></figure>
<p>这个案例是来自一款闹钟应用 Toonie。动画效果让交互变得更流畅和自然，同时整个控件颜色的改变和滑动元素形态的变化让用户能够轻易地识别出开关的状态。如果您想了解整个 App 的案例研究，可以到来源查看。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>我的主题 vuepress-theme-hope 也有一款很棒的主题模式切换开关，需将 <code v-pre>darkmode</code> 设置为 <code v-pre>'switch'</code> 即可查看</p>
</div>
<h2 id="选择器-picker" tabindex="-1"><a class="header-anchor" href="#选择器-picker" aria-hidden="true">#</a> 选择器(Picker)</h2>
<p>也很好理解，就是让用户在一些选项里选出目标选项。通常包含一个可滑动的列表，上面是一列数值，比如小时，分钟，日期，度量，币种等等。通过滑动列表，用户可以选定想要的数值。这个元素广泛地应用在有时间设定这个功能的界面设计上。</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/picker.gif" alt="选择器案例" tabindex="0" loading="lazy"><figcaption>选择器案例</figcaption></figure>
<h2 id="复选框-checkbox" tabindex="-1"><a class="header-anchor" href="#复选框-checkbox" aria-hidden="true">#</a> 复选框(Checkbox)</h2>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/checkbox.jpg" alt="复选框" tabindex="0" loading="lazy"><figcaption>复选框</figcaption></figure>
<p>上面这个是一个待办事项 App 的概念设计。用户点击复选框后，表示这个内容已经完成。字体变粗的同时颜色发生了改变，这样就非常明显地把这个已完成的任务和其他未完成的任务区分开来。</p>
<h2 id="图标-icons" tabindex="-1"><a class="header-anchor" href="#图标-icons" aria-hidden="true">#</a> 图标(Icons)</h2>
...
<h3 id="交互式图标-interactive-icons" tabindex="-1"><a class="header-anchor" href="#交互式图标-interactive-icons" aria-hidden="true">#</a> 交互式图标(interactive icons)</h3>
<p>这类图标具备交互功能。他们是可点击的，能回应用户的要求，触发图标代表的动作。这种图标告知用户按钮、控件或者其他界面交互元素的功能或者特点。在大多数情况下，这类图标的意义明确，不需要文字辅助说明。</p>
<h3 id="说明性图标-clarifying-icons" tabindex="-1"><a class="header-anchor" href="#说明性图标-clarifying-icons" aria-hidden="true">#</a> 说明性图标(clarifying icons)</h3>
<p>起到说明作用的图标，设计师用它来表示某一个特点或者内容的种类。它有时候不属于界面布局的元素或者并不具备直接的交互功能。经常和文字结合使用。</p>
<h3 id="娱乐性和装饰性图标-entertaining-and-decorative-icons" tabindex="-1"><a class="header-anchor" href="#娱乐性和装饰性图标-entertaining-and-decorative-icons" aria-hidden="true">#</a> 娱乐性和装饰性图标(entertaining and decorative icons)</h3>
<p>这类图标注重抓人眼球的视觉效果并非功能，通常用在节日或者特别款的场景。他们能有效地吸引用户的注意力，增强视觉冲击力。</p>
<p>复活节和春天主题的图标:</p>
<h3 id="app-图标-app-icons" tabindex="-1"><a class="header-anchor" href="#app-图标-app-icons" aria-hidden="true">#</a> APP 图标(app icons)</h3>
<p>在各个平台上可交互的品牌标志，展示品牌和产品的形象。最常见的就是我们手机界面上每一个 App 的图标，上面通常是品牌和产品的 Logo。</p>
<h3 id="网页图标-favicons" tabindex="-1"><a class="header-anchor" href="#网页图标-favicons" aria-hidden="true">#</a> 网页图标(favicons)</h3>
<p>就是我们经常在网址栏或者书签里看到的 URL 前面的那个小图标，也是代表着产品或者品牌的形象。能让用户在浏览网页时给他们快速的视觉提示。</p>
<h2 id="搜索区域-search-field" tabindex="-1"><a class="header-anchor" href="#搜索区域-search-field" aria-hidden="true">#</a> 搜索区域(Search Field)</h2>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/search.gif" alt="十分有设计感的交互式设计" tabindex="0" loading="lazy"><figcaption>十分有设计感的交互式设计</figcaption></figure>
...
<h2 id="标签-tag" tabindex="-1"><a class="header-anchor" href="#标签-tag" aria-hidden="true">#</a> 标签(Tag)</h2>
