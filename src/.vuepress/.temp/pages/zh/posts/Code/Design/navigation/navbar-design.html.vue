<template><div><p>评判导航菜单的设计好坏有多种不同的维度，由于它太过常用，它的好坏并没有得到更多重视。实际上，导航作为网站设计的一个基础组成部分，对于可用性的要求并不低。以下是一些常见的设计技巧。</p>
<h2 id="超大菜单栏" tabindex="-1"><a class="header-anchor" href="#超大菜单栏" aria-hidden="true">#</a> 超大菜单栏</h2>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/big-navbar.jpg" alt="超大菜单栏" tabindex="0" loading="lazy"><figcaption>超大菜单栏</figcaption></figure>
...
<h2 id="加入显眼的搜索框" tabindex="-1"><a class="header-anchor" href="#加入显眼的搜索框" aria-hidden="true">#</a> 加入显眼的搜索框</h2>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/navbar-with-search.jpg" alt="加入显眼的搜索框" tabindex="0" loading="lazy"><figcaption>加入显眼的搜索框</figcaption></figure>
...
<h2 id="限制导航内条目数量" tabindex="-1"><a class="header-anchor" href="#限制导航内条目数量" aria-hidden="true">#</a> 限制导航内条目数量</h2>
...
<h2 id="更聪明的导航机制" tabindex="-1"><a class="header-anchor" href="#更聪明的导航机制" aria-hidden="true">#</a> 更聪明的导航机制</h2>
...
<h2 id="正确地排布导航内的条目" tabindex="-1"><a class="header-anchor" href="#正确地排布导航内的条目" aria-hidden="true">#</a> 正确地排布导航内的条目</h2>
...
<h2 id="长滚动页面上使用悬浮导航" tabindex="-1"><a class="header-anchor" href="#长滚动页面上使用悬浮导航" aria-hidden="true">#</a> 长滚动页面上使用悬浮导航</h2>
...
<h2 id="不要隐藏导航" tabindex="-1"><a class="header-anchor" href="#不要隐藏导航" aria-hidden="true">#</a> 不要隐藏导航</h2>
<p>超小的汉堡图标，隐藏在页脚、不显眼的链接，或者在长滚动页面中时隐时现的悬浮菜单，都会让用户觉得难以掌控。这些“躲闪”的导航元素让用户难以与之进行交互。相反，时刻存在的导航让用户会更加安心，让用户时刻都拥有离开、跳转的安全通道。</p>
<h2 id="使用描述性的标签文本" tabindex="-1"><a class="header-anchor" href="#使用描述性的标签文本" aria-hidden="true">#</a> 使用描述性的标签文本</h2>
...
<h2 id="尝试全页面导航" tabindex="-1"><a class="header-anchor" href="#尝试全页面导航" aria-hidden="true">#</a> 尝试全页面导航</h2>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/full-navigate.jpg" alt="全页面导航" tabindex="0" loading="lazy"><figcaption>全页面导航</figcaption></figure>
<p>导航这件事玩法有很多，如果您真的想做的更醒目一些，不妨采用全页面式的导航，绝对不会让用户错过。</p>
<p>对于作品集和相对较小的实验性网站，这种非常规的设计有时候能出奇效。</p>
<h2 id="垂直导航" tabindex="-1"><a class="header-anchor" href="#垂直导航" aria-hidden="true">#</a> 垂直导航</h2>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/vertical-navbar.jpg" alt="垂直导航" tabindex="0" loading="lazy"><figcaption>垂直导航</figcaption></figure>
