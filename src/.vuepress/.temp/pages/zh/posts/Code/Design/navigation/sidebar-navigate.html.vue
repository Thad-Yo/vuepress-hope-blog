<template><div><p>厌倦了传统顶部导航的设计师，越来越偏爱侧边栏导航了。这种常见于页面左侧的侧边栏设计，已经成了许多独树一帜的设计师的选择了。</p>
<h2 id="无处不在的侧边栏导航" tabindex="-1"><a class="header-anchor" href="#无处不在的侧边栏导航" aria-hidden="true">#</a> 无处不在的侧边栏导航</h2>
<p>侧边栏导航和菜单设计的演变有着密不可分的关系。响应式设计的流行使得向移动端偏移的网页设计，不得不采用菜单栏来替代传统的导航模式，其直接的影响就是催生了汉堡图标。</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/sidebar-navigate1.jpg" alt="侧边栏导航" tabindex="0" loading="lazy"><figcaption>侧边栏导航</figcaption></figure>
...
<h2 id="侧边栏导航的优点" tabindex="-1"><a class="header-anchor" href="#侧边栏导航的优点" aria-hidden="true">#</a> 侧边栏导航的优点</h2>
<p>侧边栏导航的美学特征是毋庸置疑的。它在互联网存在的早期就已经存在，在软件的 GUI 设计中常常可以看到，但是在今天它仍然以一种时尚而前卫的姿态出现。</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/sidebar-navigate2.jpg" alt="侧边栏导航示意图" tabindex="0" loading="lazy"><figcaption>侧边栏导航示意图</figcaption></figure>
...
<h2 id="侧边栏导航的缺点" tabindex="-1"><a class="header-anchor" href="#侧边栏导航的缺点" aria-hidden="true">#</a> 侧边栏导航的缺点</h2>
<p>不喜欢侧边栏导航的人也很多，有些争论是关于导航栏放在右侧会不会更好，还有人则觉得侧边栏导航本身就是个麻烦，一方面让用户面对更复杂的布局，另一方面还增加了开发的难度。</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/sidebar-navigate3.jpg" alt="侧边栏导航示意图" tabindex="0" loading="lazy"><figcaption>侧边栏导航示意图</figcaption></figure>
...
<h2 id="侧边栏导航是否好用" tabindex="-1"><a class="header-anchor" href="#侧边栏导航是否好用" aria-hidden="true">#</a> 侧边栏导航是否好用</h2>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/sidebar-navigate4.jpg" alt="侧边栏导航示意图" tabindex="0" loading="lazy"><figcaption>侧边栏导航示意图</figcaption></figure>
...
<h2 id="其他的导航模式" tabindex="-1"><a class="header-anchor" href="#其他的导航模式" aria-hidden="true">#</a> 其他的导航模式</h2>
...
<figure><img src="@source/zh/posts/code/Design/navigation/assets/sidebar-navigate5.gif" alt="侧边栏导航示意图" tabindex="0" loading="lazy"><figcaption>侧边栏导航示意图</figcaption></figure>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/sidebar-navigate6.jpg" alt="侧边栏导航示意图" tabindex="0" loading="lazy"><figcaption>侧边栏导航示意图</figcaption></figure>
