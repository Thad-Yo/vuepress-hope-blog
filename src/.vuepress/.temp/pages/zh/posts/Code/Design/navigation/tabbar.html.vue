<template><div><p>导航分很多类别，如标签导航、抽屉式导航、九宫格导航、混合组合导航、列表式导航、Tab 导航、平铺导航等等。</p>
<p>现在用到更多的导航其实是标签导航(tabbar)，它随处可见，相信目前大部分的 App 用的导航都是标签形式的。</p>
<h2 id="理清产品框架" tabindex="-1"><a class="header-anchor" href="#理清产品框架" aria-hidden="true">#</a> 理清产品框架</h2>
...
<h2 id="标签导航的优劣势" tabindex="-1"><a class="header-anchor" href="#标签导航的优劣势" aria-hidden="true">#</a> 标签导航的优劣势</h2>
<p>先来看个图:</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/wechat.png" alt="微信页面" tabindex="0" loading="lazy"><figcaption>微信页面</figcaption></figure>
...
<h2 id="标签导航的延展" tabindex="-1"><a class="header-anchor" href="#标签导航的延展" aria-hidden="true">#</a> 标签导航的延展</h2>
<p>有的人会问，如果我的产品很想用标签导航，但是又超过了 5 个功能，那有办法解决么?</p>
<figure><img src="@source/zh/posts/code/Design/navigation/assets/zhihu.png" alt="知乎页面" tabindex="0" loading="lazy"><figcaption>知乎页面</figcaption></figure>
