...
<figure><img src="@source/zh/posts/Design/icon/assets/place-same.jpg" alt="替换淘宝图标" tabindex="0" loading="lazy"><figcaption>替换淘宝图标</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/icon-size.jpg" alt="图标尺寸" tabindex="0" loading="lazy"><figcaption>图标尺寸</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/icon-template.jpg" alt="图标模板" tabindex="0" loading="lazy"><figcaption>图标模板</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/58icon.jpg" alt="58 同城图标" tabindex="0" loading="lazy"><figcaption>58 同城图标</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/icon-change.jpg" alt="改变图标状态" tabindex="0" loading="lazy"><figcaption>改变图标状态</figcaption></figure>
<p>还有，一些包含在控件内的图标，也会跟随控件状态的变更发生变更。例如在账号输入框中，如果选中了输入框，那么图标的色彩也得到改变。如果输入框目前处于不可输入状态，那么图标也会对应置灰。</p>
<figure><img src="@source/zh/posts/Design/icon/assets/icon-change2.jpg" alt="改变图标状态" tabindex="0" loading="lazy"><figcaption>改变图标状态</figcaption></figure>
<p>合格的 UI 设计师会充分考虑到图标所变换的各种状态，并在提交给开发的过程中会进行详细的说明、归类。以及，充分运用 Sketch 等软件中的组件功能，提升项目的效率和最后的产出成果。</p>
<figure><img src="@source/zh/posts/Design/icon/assets/sketch.jpg" alt="提升效率" tabindex="0" loading="lazy"><figcaption>提升效率</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/border.jpg" alt="图标的边界" tabindex="0" loading="lazy"><figcaption>图标的边界</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/name-example.jpg" alt="命名示例" tabindex="0" loading="lazy"><figcaption>命名示例</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/png-export.jpg" alt="位图导出" tabindex="0" loading="lazy"><figcaption>位图导出</figcaption></figure>
