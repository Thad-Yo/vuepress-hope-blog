...
<figure><img src="@source/zh/posts/Design/icon/assets/app-layout.jpg" alt="由图片、文字、几何、图标组成的界面" tabindex="0" loading="lazy"><figcaption>由图片、文字、几何、图标组成的界面</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/clear-app.jpg" alt="Clear APP 的截图" tabindex="0" loading="lazy"><figcaption>Clear APP 的截图</figcaption></figure>
...
<figure><img src="@source/zh/posts/Design/icon/assets/icon-effect.jpg" alt="应用文字替换了图标的对比" tabindex="0" loading="lazy"><figcaption>应用文字替换了图标的对比</figcaption></figure>
<p>第二点，就是关于视觉的观赏性。有些页面中，如果把图标去掉了，也丝毫不会影响操作效率，以及对内容的理解。但没有图标，缺少这些点缀，这个页面看起来就会太枯燥，最好的例子就是应用的设置页了，见下方案例。</p>
<figure><img src="@source/zh/posts/Design/icon/assets/icon-compare.jpg" alt="设置页有图标和没有图标的对比" tabindex="0" loading="lazy"><figcaption>设置页有图标和没有图标的对比</figcaption></figure>
